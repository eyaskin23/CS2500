...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname P1-more-ISL-list-abst) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; get-rendered-g1s : Game1String -> 1String
...
; map: (X Y Z) [X Z -> Y] [List-of X] -> [List-of Y]
