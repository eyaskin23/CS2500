...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |P2-misc-list-absts (1)|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; SORT
...
; Time permitting, discuss Exam 1.
