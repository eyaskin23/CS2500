...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |lecture 6 notes p1|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (draw-eclipse x-moon)
  (place-image MOON
               ...
               (place-image SUN)
                            ...
                            (cond
                              [and (>= - x-moon (- (/ SKY-WIDTH 2) 5))
                                   (<= - x-moon (+ (/ SKY-WIDTH 2) 5))
                                   DARKSKY]
