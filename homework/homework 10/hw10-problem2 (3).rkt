...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |hw10-problem2 (3)|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; max-length : BinTree-of String -> Nat
...
; flatten : BinTree-of String -> List-of Leaf
...
; map-tree : BinTree-of Number -> Boolean 
...
(define (map-tree bton func)
  (reduce-tree make-node (λ (f) (make-leaf (func f))) bton))
