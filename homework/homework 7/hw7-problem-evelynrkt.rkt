...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |hw7-problem1 (1)|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image) 
...
; lunch-course : ? -> LunchCourse

(check-expect (lunch-course "LT" "101" "Exciting Baking" "Alderton" (list WEEKDAY-M WEEKDAY-T WEEKDAY-W WEEKDAY-R WEEKDAY-F))
              (make-course "LT" "101" "Exciting Baking" "Alderton" (list
               (make-meeting WEEKDAY-M  "Hayden Hall" "101" "12""0" "60")
               (make-meeting WEEKDAY-T  "Hayden Hall" "101" "12""0" "60")
               (make-meeting WEEKDAY-W  "Hayden Hall" "101" "12""0" "60")
               (make-meeting WEEKDAY-R  "Hayden Hall" "101" "12""0" "60")
               (make-meeting WEEKDAY-F  "Hayden Hall" "101" "12""0" "60"))))  
...
; lunch-every-day : Meeting -> Meeting
; for every weekday, we create a meeting time for lunch

(check-expect (lunch-every-day CM-FUNDIES-M)
              (make-meeting
               "Hayden Hall"
                "101"
                "12"
...
; long-weekend? Course Schedule -> Boolean
...
; determines if the supplied list contains the specific weekday
...
; meets-on-monday-friday : ClassMeeting -> Boolean
; determines which courses don't meet on monday/friday
...
; Returns the total number of minutes spent in class.
...
(define (course->image cm)
  (combine-text (string-append (course-prefix cm) " " (course-num cm) " (" (course-name cm) ", " (course-prof cm) "): "
